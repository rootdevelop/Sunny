...
// Manuali added for pushnotification
using Windows.Networking.PushNotifications;
using Microsoft.WindowsAzure.Messaging;

// The Blank Application template is documented at http://go.microsoft.com/fwlink/?LinkId=234227
using Sunny.WindowsStore.Controls;
...
namespace Sunny.WindowsStore
{
    ...
    sealed partial class App : Application
    {
        ...
        /// <summary>
        /// Supports application settings via the charms bar. Returns list of valid settings commands for the current page
        /// </summary>
        ...
        private void OnCommandsRequested(SettingsPane sender, SettingsPaneCommandsRequestedEventArgs args)
        {
            ...
            {
                //var about = new SettingsCommand("about", "About", AboutClick);
                //args.Request.ApplicationCommands.Add(about);
            }
        }

        private void AboutClick(IUICommand command)
        {
            var settingsFlyout = new Common.SettingsFlyout(550);
            settingsFlyout.ShowFlyout(new AboutUserControl());
        }
